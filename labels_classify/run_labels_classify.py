...
def main(args):
    ...
    TOKEN_DICTIONARY_FILE = r'../cgm_ckp/token2id.pkl'  # Repalce it with your token_dictionary
    ...
    # 获取权重文件名（os需要先 import os）
    ckpt_name = os.path.basename(args.checkpoint_path)
    # 修改 output_dir 定义：
    output_dir = output_path + f"/{decs}_{datestamp}_{ckpt_name}_L{max_input_size}_B{batch_size}_LR{max_lr}_LS{lr_schedule_fn}_WU{warmup_steps}_E{epochs}_O{optimizer}_F{freeze_layers}/"
